...
function padString(original, length, padWith, side) {
  ...
  if (side === "start") {
    let string = original.padStart(length, padWith);
    return string;
  } else if (side === "end") {
    let string = original.padEnd(length, padWith);
    return string;
  } else {
...
function trimString(original, side) {
  ...
  if (side === "start") {
    let string = original.trimStart(original);
    return string;
  } else if (side === "end") {
    let string = original.trimEnd(original);
    return string;
  } else if (side === "both") {
    let string = original.trim(original);
    return string;
  }
...
function convertCase(original, caseType) {
  ...
  if (caseType === "lower") {
    let string = original.toLowerCase();
    return string;
  } else if (caseType === "upper") {
    let string = original.toUpperCase();
    return string;
  }
